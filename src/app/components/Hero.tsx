      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            ...
            <span className="text-sm">Premium Handcrafted Lighting</span>
          </motion.div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight">
            <span className="block text-foreground">KUN is a light</span>
            <span className="block bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
              that revives
            </span>
            <span className="block text-foreground">memories</span>
          </h1>

          <p className="text-xl text-muted-foreground max-w-xl">
            Transform your space with our exclusive collection of handcrafted lamps and personalized lithophany.
            Each piece radiates warmth, creating an atmosphere of comfort and elegance.
          </p>
